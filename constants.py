...
Create a flowchart using Mermaid syntax. Each major class is a node, and links to all the user created classes it references. Don't reply with anything other than Mermaid syntax.
"""
...
Create a flowchart using Mermaid syntax. Each repository is a node, and links to other repositories it calls or external APIs. Don't reply with anything other than Mermaid syntax.
"""